...
<html lang="en">
	...
	<head>
		...
		<title>Link Sent | tourism_management</title>
		...
		<div class="forgotPassword">
			...
			<div class="col-sm-6 col-sm-offset-3">
				...
				<div class="containerBoxMod">
					...
					<a href="http://localhost/TourBuddie/home.php"><input type="button" class="button" name="login" value="Go back to homepage"></a>
					</div>
